    ...
    <PopupState variant="popover" popupId="demo-popup-popover">
      {(popupState) => (
        <div>
          ...
          <CButton type="button" onClick={() => props.remove(props.data)} className="remove-file-ongoing"><img src={"assets/icons/icons8-close-64-blue.svg"} className="close-icon-size" /></CButton>
          <Popover
