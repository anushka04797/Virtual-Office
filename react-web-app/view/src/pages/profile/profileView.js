...
import { CLabel,CContainer, CNav, CNavItem, CNavLink, CTabPane, CTabContent, CRow, CTabs, CCard, CButton, CImg, CCardBody, CModal, CModalHeader, CModalTitle, CModalBody,CForm, CInput } from '@coreui/react'
            ...
            <CContainer>
                ...
                <CModal alignment="center"
                    ...
                    <CModalHeader onDismiss={() =>setVisible(!visible)} closeButton>
                        <CModalTitle className="modal-title"><span className="edit-profile-form-header">Edit Profile Info</span></CModalTitle>
                    </CModalHeader>
...
<CLabel className="custom-label-5" htmlFor="userFName">
                        ...
                        <CInput type="text" name="userFName" className="custom-forminput-6"></CInput>
</div>
{/**Last Name */}
<div className="col-md-6">
<CLabel className="custom-label-5" htmlFor="userLName">
                        ...
                        <CInput type="text" name="userLName" className="custom-forminput-6"></CInput>
</div>
{/**Job title */}
...
<CLabel className="custom-label-5" htmlFor="uEmail">
                        ...
                        <CInput type="email" name="uEmail" className="custom-forminput-6"></CInput>
</div>
{/**Email */}
<div className="col-md-12">
<CLabel className="custom-label-5" htmlFor="uJobTitle">
                        ...
                        <CInput type="text" name="uJobTitle" className="custom-forminput-6"></CInput>
</div>
{/**Phone */}
<div className="col-md-12">
<CLabel className="custom-label-5" htmlFor="uPhoneNo">
                        ...
                        <CInput type="tel" name="uPhoneNo" className="custom-forminput-6"></CInput>
</div>

{/**Button groups */}
<div className="col-md-12 ">
    <div className="project-form-button-holders mt-3">
    <CButton className="profile-form-btn update-profile">Update Info</CButton>
                ...
                <CTabs activeTab="viewProfile">
                    <CNav variant="tabs" className="tab-style" >
                        ...
                        {/**change password */}
                        <CNavItem>
                            <CNavLink data-tab="changePassword" className="special"><CIcon name="cil-pen-alt" className="mr-1" />Change Password</CNavLink>
                        </CNavItem>
                                    ...
                                    <div className="col-md-8 offset-md-2">
                                        ...
                                        <CCard className="card-view-profile mt-3">
                                            <div className="user-profile-pic-div text-center">
                                                ...
                                                <CButton onClick={onButtonClick} className="d-block mx-auto change-img-btn mt-1">
                                                    {" "}
                                            ...
                                            <CCardBody>
                                                <hr />
                                                <CButton className="edit-profile mb-3" onClick={() => profileEditForm()}><CIcon name="cil-pen" className="mr-1"  />Edit Info</CButton>
                                                ...
                                                <div className="row justify-content-center">
                                                    ...
                                                    <div className="col-md-6">
                                                        ...
                                                        <h5 className="project-details-points child">fahmida.pranto@dma-bd.com</h5>


                                                    </div>
                                                    <div className="col-md-6">
                                                        <h5 className="info-header-1">Job title</h5>
                                                        <h5 className="project-details-points child">Front End Developer </h5>

                                                    </div>
                                                    <div className="col-md-6">
                                                        <h5 className="info-header-1"> Phone</h5>
                                                        <h5 className="project-details-points child">01684911581</h5>
