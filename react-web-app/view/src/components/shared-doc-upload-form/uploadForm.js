...
const UploadDocuments = () => {
  ...
  const upload=()=>{
    ...
    API.post('shared/document/create/',formData)
  }
  ...
  function remove_file(index){
    console.log(arrayRemoveItem(fileAvatars,index))
    setFileAvatars(arrayRemoveItem(fileAvatars,index))
    setFiles(arrayRemoveItem(files,index))
  }
  return (
    <>
