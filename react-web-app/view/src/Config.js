...
const status = 'prod'
export const API_URL = status === 'prod' ? 'http://192.168.0.225:8003/' : 'http://www.vo.com.bd/vo-admin/'
export const TOKEN = "access_token"
export const USER_ID = "user_id"
export const PERMISSIONS = "user_permissions"
export const BASE_URL = status === 'prod' ? 'http://192.168.0.225:8003' : 'http://www.vo.com.bd/vo-admin'
