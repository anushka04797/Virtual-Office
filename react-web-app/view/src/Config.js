...
const status = 'dev'
export const API_URL = status === 'prod' ? 'https://virtualoffice.com.bd/vo-admin/' : 'http://localhost:8000/'
export const TOKEN = "access_token"
export const USER_ID = "user_id"
export const PERMISSIONS = "user_permissions"
export const BASE_URL = status === 'prod' ? 'https://virtualoffice.com.bd/vo-admin' : 'http://localhost:8000'
