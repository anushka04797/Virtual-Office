...
const status = 'dev'
export const API_URL = status === 'prod' ? 'https://virtualoffice.com.bd/vo-admin/' : 'http://192.168.0.225/vo-admin/'
export const TOKEN = "access_token"
export const USER_ID = "user_id"
export const PERMISSIONS = "user_permissions"
export const BASE_URL = status === 'prod' ? 'https://virtualoffice.com.bd/vo-admin' : 'http://192.168.0.225/vo-admin'
