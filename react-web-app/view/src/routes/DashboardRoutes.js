...
const routes = [
    ...
    { path: '/dashboard/Projects/ongoing-projects/details/:id',exact:true, name: 'Ongoing Project Details', component: React.lazy(()=>import('../pages/ongoing-project-details-view/OngoingProjectDetailsView'))},
    ...
    {path:'/dashboard/Projects/completed-projects/details/:id',exact:true,name:'Completed Projects details',component:React.lazy(()=>import('../pages/completed-project-details-view/CompletedProjectDetails'))},
